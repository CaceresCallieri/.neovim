...
-- Kanagawa theme for testing porposes
-- return {
...
-- 					TelescopePromptBorder = { fg = "#C2C2C2", bg = "none" },
-- 					TelescopeResultsNormal = { fg = theme.ui.fg_dim, bg = "none" },
-- 					TelescopeResultsBorder = { fg = "#C2C2C2", bg = "none" },
-- 					-- TelescopePreviewNormal = { bg = theme.ui.bg_dim },
-- 					TelescopePreviewBorder = { fg = "#C2C2C2", bg = "none" },
--
